...
from clustering.entity_clustering import cluster_sentences_with_entities
...
class Clustering:
    def __init__(self, num_clusters=5, eps=0.3, min_samples=5):
    ...
    def cluster(self, method, arguments):
        """
        ...
        if method == "kmeans":
            ...
            return cluster_sentences_with_entities(arguments=arguments, num_clusters=self.num_clusters)
